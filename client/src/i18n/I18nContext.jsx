...
import { betaTranslations } from './betaTranslations'
import { coupleInviteTranslations } from './coupleInviteTranslations'
...
import { adminLocationsTranslations } from './adminLocationsTranslations'
import { adminSubscriptionPlansTranslations } from './adminSubscriptionPlansTranslations'
...
const mergedAdminTranslations = Object.fromEntries(SUPPORTED_LANGUAGES.map(language => [language, {
  admin: {
    ...
    ...adminLocationsTranslations[language].admin,
    ...adminSubscriptionPlansTranslations[language].admin,
    users: {
...
const supplementalCatalogs = {
  ...
  otp: otpTranslations,
  beta: betaTranslations,
  coupleInvite: coupleInviteTranslations,
  travel: travelTranslations,

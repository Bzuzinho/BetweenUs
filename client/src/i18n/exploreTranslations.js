export const exploreTranslations = {
  'pt-PT': {
    ...
    viewMatches:'Ver matches', loadError:'Não foi possível carregar os perfis.', retry:'Tentar novamente',
  ...
  en: {
    ...
    viewMatches:'View matches', loadError:'Unable to load profiles.', retry:'Try again',
  ...
  fr: {
    ...
    viewMatches:'Voir les matchs', loadError:'Impossible de charger les profils.', retry:'Réessayer',

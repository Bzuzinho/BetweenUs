...
export const INDIVIDUAL_SCENARIOS: IndividualScenario[] = [
  { key: 'individual_marta', email: email('beta.marta'), displayName: 'Marta', accountName: 'Marta Teste',
    ...
    scenario: 'Individual aberta a casais — Third Match', expected: ['Aparece como candidata para Casal 1 (seek_third)', 'Between Score alto com Casal 1'] },
  ...
  { key: 'individual_joana', email: email('beta.joana'), displayName: 'Joana', accountName: 'Joana Teste',
    ...
    scenario: 'Ligação recorrente — score alto com Marta', expected: ['Between Score alto com individual_marta (mesma cidade, intenções sobrepostas)'] },
  ...
  { key: 'individual_miguel', email: email('beta.miguel'), displayName: 'Miguel', accountName: 'Miguel Teste',
    ...
    boundaries: [],
    isPremium: true,
    scenario: 'Premium — filtros avançados', expected: ['Subscription plan=PREMIUM status=ACTIVE'] },
  { key: 'individual_sofia', email: email('beta.sofia'), displayName: 'Sofia', accountName: 'Sofia Teste',
    ...
    scenario: 'Galeria privada / Soft Reveal', expected: ['Tem ProfilePhoto PRIVATE_AFTER_APPROVAL', 'PhotoAccessRequest/Approval cenário Soft Reveal'] },
